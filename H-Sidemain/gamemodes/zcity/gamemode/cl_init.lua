...
local SB = {
	...
	line     = Color(255, 50, 50, 90),
	text     = Color(225, 225, 225),
	textDim  = Color(160, 160, 160),
	white    = Color(255, 255, 255, 240),
	accent   = Color(255, 0, 0, 240),
	grip     = Color(120, 40, 40, 180),
}
...
local function SB_MakeButton(parent, label, getActive, onClick)
	...
	function btn:Paint(w, h)
		...
		surface.SetDrawColor(40, 10, 10, 120 + 45 * self.HoverLerp)
		surface.DrawRect(0, 0, w, h)
		if on then
			surface.SetDrawColor(SB.accent.r, SB.accent.g, SB.accent.b, 55)
			surface.DrawRect(0, 0, w, h)
		end
		surface.SetDrawColor(255, 50, 50, 40 + 70 * self.HoverLerp)
		surface.DrawOutlinedRect(0, 0, w, h, 1)
		surface.SetDrawColor(on and SB.accent.r or 255, on and SB.accent.g or 50, on and SB.accent.b or 50, on and 220 or 55)
...
function GM:ScoreboardShow()
	...
	scoreBoardMenu:SetColorBG(Color(20, 5, 5, 252))
	...
	header.Paint = function(pnl, w, h)
		surface.SetDrawColor(20, 0, 0, 215)
		surface.DrawRect(0, 0, w, h)
	...
	local function AddPlayerRow(scroll, ply, spectator)
		...
		function row:Paint(w, h)
			...
			surface.SetDrawColor(85, 40, 40, 120 + 40 * self.HoverLerp)
			surface.DrawTexturedRect(0, 0, w, h)
			surface.SetDrawColor(20, 0, 0, 145)
			surface.DrawRect(0, 0, w, h)
			...
			elseif spectator then
				surface.SetDrawColor(130, 80, 80, 150)
				surface.DrawRect(0, 0, SB_Unit(2), h)
			end

			surface.SetDrawColor(255, 50, 50, 30 + 55 * self.HoverLerp)
			surface.DrawOutlinedRect(0, 0, w, h, 1)
		...
		avatar.PaintOver = function(self, w, h)
			surface.SetDrawColor(255, 50, 50, 45)
			surface.DrawOutlinedRect(0, 0, w, h, 1)
		end
...
concommand.Add("zb_snake", function()
	local lp = LocalPlayer()
	if not (lp:IsAdmin() or (lp.CheckGroup and (lp:CheckGroup("admin") or lp:CheckGroup("superadmin")))) then
		print("[Snake Game] Доступно только администраторам!")
		return
	end
